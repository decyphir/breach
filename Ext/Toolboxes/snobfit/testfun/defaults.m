...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% defaults.m %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [u,v,fglob,xglob] = defaults(fcn)
% sets the default values for the dimension n and the default original
% box [u,v] for the functions fcn in {'bra','cam','gpr','hm3','hm6',
% 'ros','sh10','sh5','sh7','shu'}
function [u,v,fglob,xglob] = defaults(fcn)
% u,v          default box bounds
% fglob        global minimum of fcn
% xglob(1:n,1:nglob)  xglob(:,i), i = 1:nglob, are the global
%              minimizers of a test function fcn in [u,v], where
%              nglob = size(xglob,2) is the number of global minimizers
...
elseif strcmp(fcn,'sh7')  % Shekel 7
  ...
  xglob = [4; 4; 4; 4];
elseif strcmp(fcn,'sh10')  % Shekel 10
  u = [0; 0; 0; 0];
  v = [10; 10; 10; 10]; 
...
elseif strcmp(fcn,'ros')  % Rosenbrock
  u = -5.12*ones(2,1);
  v = -u;
  fglob = 0;
  xglob = [1; 1];

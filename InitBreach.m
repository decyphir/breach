...
list_path = { ...
    ...
    [br_dir filesep 'Ext' filesep 'Toolboxes' filesep 'wordgen'], ...
    [br_dir filesep 'Ext' filesep 'Toolboxes' filesep 'turbo'], ...
    [br_dir filesep 'Ext' filesep 'Toolboxes' filesep 'SDT'],...
    [br_dir filesep 'Ext' filesep 'Toolboxes' filesep 'SDT' filesep 'Functions'],...
    [br_dir filesep 'Ext' filesep 'Toolboxes' filesep 'SDT' filesep 'ExampleBand-Pass'],...
    [br_dir filesep 'Ext' filesep 'Toolboxes' filesep 'SDT' filesep 'ExampleLow-Pass']
    };
...
%% embarrassing warnings 
% seem harmless but still TODO: investigate.
id_par = 'MATLAB:parallel:loadsave:CannotSaveCorrectly';
warning('off', id_par);
end

		...
		int nrhs, const mxArray *prhs[])
{
	...
	{
		mexWarnMsgTxt("RobustAvEvLeft: lengths of time steps and signal are different.");
	}
	...
	if (b-a < 0)
	{
		mexWarnMsgTxt("RobustAvEvLeft: in interval [a, b], b-a < 0 ! Treated as 0.");
		yev = y;
	}
	else
	{
		...
		else
		{
			...
			{
				yev = computeLeftAvEventually(y, b-a);
